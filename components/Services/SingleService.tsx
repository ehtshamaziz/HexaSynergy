...
const SingleFeature = ({ feature }: { feature: Feature }) => {
  ...
  return (
    <div className="service-card group relative flex w-full flex-col items-center border border-[#f2f4ff] bg-primary/[.03] px-6 xl:px-10 2xl:px-12 pb-8 pt-24 text-center shadow-lg transition-all duration-500 hover:shadow-xl dark:border-none dark:bg-[#1D2144] dark:shadow-[#14183a]">
